...
public class Admin implements Initializable {
    ...
    private void setAdminSearchButtonClick(Event event){
        System.out.println(adminTFSearch.getText());
        String sqlQuery = "select * from student where dbStudentID = "+adminTFSearch.getText()+";";//add query
    ...
    private void setAdminEditButtonClick(Event event){
        ...
        System.out.println(getSelectedRow.getAdminTableDataStudentID());
